...
./run_local.sh pytorch dlrm kaggle cpu $dtype $test_type --scenario $mode --max-ind-range=10000000 --samples-to-aggregate-quantile-file=../tools/dist_quantile.txt --max-batchsize=$batch_size $extra_option
